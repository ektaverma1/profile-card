    ...
    <main>
      <div className="profile-card">
        <div className="card-header">
          <img src="/profile.png" alt="profile thumbnail" className="avatar" />
          <div className="profile-info">
            <p className="profile-name">Sarah Dole</p>
            <p className="profile-title">Front End Engineer @ Microsoft</p>
          </div>
        </div>
